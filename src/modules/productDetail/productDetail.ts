...
class ProductDetail extends Component {
  ...
  private _setInFavorite() {
    ...
    this.view.heartSelected.classList.remove('hidden');
  }

  private _setNotInFavorite() {
    this.view.heart.classList.remove('hidden');
    this.view.heartSelected.classList.add('hidden');
  }
